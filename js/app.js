		...
		getTileImage: function(rawCoordinates, zoomLevel) {
			...
			if (!coord) {
				return null;
						...
						return 'https://raw.githubusercontent.com/Matlik-Official/WKND-interactive-map/assets-cayo/tiles/' + this.mapType.toLowerCase() + '/' + zoomLevel + '/' + coord.x + '_' + coord.y + '.png';
		},
